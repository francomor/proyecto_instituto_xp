<?php
//este fichero php se utiliza para obtener un pdf de una pagina dada, en este caso se genera el pdf de 
//el bolentin de inasistencias, para un alumno, buscado anteriormente. 
...
if (isset($_POST['dni'])){
    ...
    //se inicializa la variable que va a contener el codigo html inicial para poder generar el pdf a posterior
