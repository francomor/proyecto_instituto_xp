 ...
 <form class="form-horizontal" role="form" id="datos_alumno" action="../logica/cargaAlumnosAlCurso.php" method="post">
    ...
    <table class="table table-bordered table-hover" border="1" width="50%">
                ...
                for ($i = 0; $i < $cantfilas; $i++) {
                    ...
                    //se hace de manera dinamica la carga de los alumnos a la tabla.
                    ?>
                    ...
                    <tr>
                       ...
                       <td> 
                          ...
                          <a href="#" class='btn btn-default bg-red' id="<?php echo $alumnos[$i]["dni"] ?>" name="BorrarAlumnoxCurso"><i class="glyphicon glyphicon-trash"></i> </a>
                       </td>
...
$("[name='BorrarAlumnoxCurso']").click( function(){
    var opcion = confirm("¿Está seguro que quiere borrar?");
    if (opcion == true) {
  var parametros = {
                  "dni" : $(this).attr('id'),
                  "idcurso" : <?php echo $curso ?>
                  };
                  $.ajax({
                   data: parametros,
                   type: "post",
                   url: "../logica/borrarAlumnoCurso.php",
                   datatype: "html",
