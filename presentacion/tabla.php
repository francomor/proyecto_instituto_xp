  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>
          <a href="registrarAsistencia.php">Asistencias</a>
        </li>
        ...
        ?>
                  <form action="../logica/guardar.php" method="post" id="formulario">
                    <div class="panel-heading ">
                      ...
                      <input type="checkbox" class="checkb" name="valorParcial" id="valorParcial"> Habilitar ed-fisica
              ...
              ?>
                        ...
                        <td width="20%" colspan="3">Fecha:
                          <input name="fecha" id="fecha" type="date" value="<?php echo date('Y-m-d', strtotime($fecha)) ?>" required>
                        ...
                        echo $nombreAlumno ?> </td>
                          ...
                          <td>
                            ...
                            <input value="clase" type="checkbox" name="<?php echo ($i + 1) . " claseAusente " ?>" id="<?php echo ($i + 1) . " claseAusente
                              " ?>" onClick="controlarCB('<?php echo ($i + 1) ?>',1)">
                          </td>
                          <td>
                            <!--checkbox para computar la llegada tarde a clase-->
                            <input value="tarde" type="checkbox" name="<?php echo ($i + 1) . " claseTarde " ?>" id="<?php echo ($i + 1) . " claseTarde
                              " ?>" onClick="controlarCB('<?php echo ($i + 1) ?>',2)">
                          </td>
                          <td>
                            ...
                            <input disabled class="hab_deshab" value="edfisica" type="checkbox" name="<?php echo ($i + 1) . " edFAusente " ?>" id="<?php echo ($i + 1) . "
                              edFAusente " ?>">
